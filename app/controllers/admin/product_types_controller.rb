class Admin::ProductTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product_type.save
        format.html { redirect_to admin_product_type_url(@product_type), notice: 'Product type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @product_type.update(product_type_params)
        format.html { redirect_to admin_product_type_url(@product_type), notice: 'Product type was successfully updated.' }
  ...
  private
    ...
    def product_type_params
      params.fetch(:product_type, {}).permit(:name, :slug, :numbers, :strings)
    end
end
